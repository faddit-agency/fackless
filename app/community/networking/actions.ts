...
export async function createNetworking(formData: FormData) {
  ...
  if (error || !inserted) {
    console.error("[createNetworking]", error);
  ...
  revalidatePath("/community/networking");
  revalidatePath("/community");
  redirect(`/community/networking/${inserted.id}`);
}
